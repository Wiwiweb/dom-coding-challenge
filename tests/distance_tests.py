...
class DistanceTests(unittest.TestCase):
    ...
    def test_13(self):
        s1 = "div#id span.text a#link.btn"
        s2 = "a#id.btn"
        expected = 4
        self.assertEqual(dom.distance(s1, s2), expected)
    ...
    def test_15(self):
        s1 = "div#id img.photo a.btn.share.link"
        s2 = "a.btn div#id img.photo"
        expected = 3
        self.assertEqual(dom.distance(s1, s2), expected)
    ...
    def test_17(self):
        s1 = "a#id.btn"
        s2 = "div#id span.text a#id.share"
        expected = 6
        self.assertEqual(dom.distance(s1, s2), expected)
    ...
    def test_19(self):
        s1 = "a#enter.knob.green a#enter a#enter a#enter"
        s2 = "a#enter.knob.green"
        expected = 3
        self.assertEqual(dom.distance(s1, s2), expected)

    def test_20(self):
        s1 = "a#enter.knob.green"
